    ...
    <div class="col-xs-12 col-lg-12 search-box">
        <form class="form-inline" id="frm" ACTION="${post_url}" METHOD="POST">
            <div class="form-group search-item">
                ...
                <input type="text" class="input-validation-error form-control" id="id"/>
            </div>
            <div class="form-group search-item">
                <label for="name" >이름</label>
                <input type="text" class="input-validation-error form-control" id="name"/>
            </div>
            <div class="form-group search-item">
                <label for="name" >성별</label>
                <input type="text" class="input-validation-error form-control" id="sex"/>
            </div>
            <div class="form-group search-item">
                <label for="birthDate" >생년월일</label>
                <input type="text" class="input-validation-error form-control" id="birthDate"/>
            </div>
            <div class="form-group search-item">
                <label for="phoneNumber" >휴대폰번호</label>
                <input type="text" class="input-validation-error form-control" id="phoneNumber"/>
            </div>
            <div class="form-group search-item">
                <label for="email" >이메일</label>
                <input type="text" class="input-validation-error form-control" id="email"/>
            </div>
        </form>
    </div>
