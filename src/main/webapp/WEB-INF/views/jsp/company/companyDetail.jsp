...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            cmCodeSelectGenerator('type', 'cpType', 10, true,true,"${companyVo.type}");
        });

        function doList(){
            location.replace("<c:url value='/company/selectCompanyView.do'/>");
        }
...
<div class="contentwrap">
    <article class="container bgc-white" >
        <div class="page-title">
            <h2 class="page-title-h2">거래처관리 <small>상세보기</small></h2>
        </div>
